...
namespace Test.BuildXL.TestUtilities.Xunit
{
    ...
    public abstract class XunitBuildXLTest : BuildXLTestBase, IDisposable, IAsyncDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// xunit v3 calls DisposeAsync instead of Dispose when both are present.
        /// Override this in subclasses that need async cleanup, and call base.DisposeAsync().
        /// </summary>
